  ...
  return (
    <div className="shadow-inner shadow-white rounded-xl bg-transparent backdrop-blur-3xl p-14">
      <div className="flex flex-col w-full gap-4">
        <ExtensionLoginButton className={buttonStyles} callbackRoute={"/"} onLoginRedirect={() => navigate("/")} loginButtonText={"Extension"} />
        <WalletConnectLoginButton className={buttonStyles} callbackRoute={"/"} onLoginRedirect={() => navigate("/")} loginButtonText={"xPortal"} />
